...
let requireLdapLogin = passport.authenticate("alumni-login", {
  session: false
});
...
router
  ...
  .post(AuthenticationController.adminChangePassword);
...
router
  .route("/signinLdap")
  .post([requireLdapLogin, AuthenticationController.signinLdap]);
router
  .route("/addFavoriteNews")
  .post(AuthenticationController.updateFavoriteNews);
router
  .route("/deleteFavoriteNews")
  .post(AuthenticationController.undoFavoriteNews);
router
  .route("/checkFavoriteNews")
  .post(AuthenticationController.checkFavoriteNews);
router
  .route("/getAllFavoriteNews/:id")
  .get(AuthenticationController.getAllFavoriteNews);
router
  .route("/getJoinedEvent/:id")
  .get(AuthenticationController.getJoinedEvent);
...
router
  .route("/getNewsByFaculty/:faculty/:offset/:limit")
